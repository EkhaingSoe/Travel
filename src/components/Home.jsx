  ...
  return (
    <div className='my-10'>
      ...
      <div className="col-span-1 xl:col-span-3 flex items-center justify-center xl:justify-start">
        <div className="">
          <h1 className="text-4xl xl:text-6xl font-semibold mb-3 text-center xl:text-left">Explore</h1>
          <div className="flex items-center gap-10 justify-center xl:justify-start">
            <h1 className="text-4xl xl:text-6xl font-semibold mb-3 ">Beautiful</h1>
            <PiStarFourFill className="text-5xl " />
          </div>
          <h1 className="text-4xl xl:text-6xl font-semibold mb-3 text-center xl:text-left">World</h1>
          {/* search  */}

          <div className="grid grid-cols-1 md:grid-cols-4 shadow-lg text-sm lg:text-base  gap-x-10">
