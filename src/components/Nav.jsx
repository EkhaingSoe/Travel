      ...
      <nav className=" py-2 px-4 md:px-20 shadow-md bg-white text-sm sticky top-0  z-[99999] font-poppins ">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:block">
            ...
            {navs.map((nav) => {
                return (
                  <li key={nanoid()} onClick={(e)=>{e.preventDefault()}}>
                    <a
                      href=""
                      className="cursor-pointer hover:underline hover:underline-offset-2 hover:text-orange-700"
                    >
                      {nav}
                    </a>
                  </li>
        ...
        <div
          className={`${
            toggle ? "" : "hidden"
          }  absolute top-[100%] w-[100%] left-0 z-[9999] bg-white border-b`}
        >
